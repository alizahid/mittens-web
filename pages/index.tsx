...
const Home: NextPage = () => (
  <>
    ...
    <header className="flex flex-col items-center justify-center my-12">
    ...
    <main>
      ...
      <section className="mt-12 flex flex-col lg:flex-row justify-center">
    ...
    <footer className="flex items-center justify-center my-12 text-gray-500">
      made with
